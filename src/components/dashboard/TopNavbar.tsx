            ...
            <div className="h-full px-4 md:px-6 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <motion.button
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        className="relative p-2 md:p-2.5 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all group"
                    >
                    ...
                    <motion.button
                        ...
                        className="hidden md:flex p-2.5 rounded-xl bg-gray-50 hover:bg-gray-100 transition-all group"
                    >
                    ...
                    <motion.div
                        ...
                        className="flex items-center gap-2 md:gap-3 pl-2 md:pl-3 pr-2 md:pr-4 py-2 rounded-xl bg-gray-50 hover:bg-gray-100 cursor-pointer transition-all shadow-sm"
                    >
